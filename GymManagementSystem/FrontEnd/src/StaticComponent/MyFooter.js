        ...
        <footer>
          <div className="container grid grid-four-column">
            <div className="footer-about">
              <h3 style={{ color: "White" }}>Silver Fitness Club</h3>
              <p style={{ color: "White" }}>
            ...
            {/* 2nd column */}
            <div className="footer-subscribe" style={{ color: "white" }}>
            ...
            <div className="footer-social">
              ...
              <div className="footer-social--icons">
                <div>
                  <a
                    href="https://www.facebook.com/SilverFitnessClub/"
                    target="_blank"
                  >
                ...
                <div>
                  <a href="https://youtu.be/GNxyWmTk_pI" target="_blank">
          ...
          <div className="footer-bottom--section">
            ...
            <div className="container grid grid-two-column">
              <p style={{ color: "White" }}>
                @{new Date().getFullYear()}SilverFitnessClub. All Rights
                Reserved
              </p>
              <div>
